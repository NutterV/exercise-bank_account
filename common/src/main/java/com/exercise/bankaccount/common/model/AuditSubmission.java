...
/**
 * Audit submission payload containing the optimized batches derived from exactly one submission window.
 *
 * @param batches ordered batches sent to the mocked audit system
 */
