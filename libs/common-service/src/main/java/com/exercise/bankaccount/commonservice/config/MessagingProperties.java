...
public record MessagingProperties(Map<QueueType, String> queues) {
	...
	private static final Map<QueueType, String> DEFAULT_QUEUES = Map.of(
		QueueType.TRANSACTION, "bank-account.transactions",
		QueueType.AUDIT, "bank-account.audit"
	);
	 ...
	 *
	 * @param queueType queue role to resolve
