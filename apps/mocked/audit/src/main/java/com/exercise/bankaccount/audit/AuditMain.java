...
/**
 * Boots the mocked audit application and begins consuming audit submissions
 * from the broker.
 */
public final class AuditMain {
	...
	/**
	 * Starts the audit listener using runtime properties resolved from system
	 * properties or environment variables.
	 *
	 * @param args
	 *            unused command-line arguments
	 * @throws Exception
	 *             if broker connection or message processing fails
	 */
